...
{
    static const StructureDefinitions &get()
    {
        static StructureDefinitions sd;
        return sd;
    }
    ...
    StructureDefinition small1 {
        ...
        std::vector<StructureFloorConnection> { StructureFloorConnection(0, 1) },

        std::vector<StructureProp> { StructureProp(1, LevelSide::top, 0.0f, 0.0f, PropDefinitions::get().side_furniture.at(0)) }
    };

    StructureDefinition small2 {
        std::vector<LevelFloorInternal> { LevelFloorInternal(Texture::floor1, 0.0f, 0.0f, 3.6f, 6.0f, false),
                                         LevelFloorInternal(Texture::floor1, 3.6f, 1.5f, 4.0f, 3.0f, false),
                                         LevelFloorInternal(Texture::floor1, -2.0f, 6.0f, 7.0f, 3.0f, false) },

        std::vector<StructureFloorConnection> { StructureFloorConnection(0, 1), StructureFloorConnection(0, 2) }
    };

    StructureDefinition small3 {
        std::vector<LevelFloorInternal> { LevelFloorInternal(Texture::floor1, 0.0f, 0.0f, 8.0f, 2.2f, false),
    ...
    std::vector<StructureDefinition *> all { //&testpattern,
                                             &small1,
                                             &small2,
                                             &small3
    };
