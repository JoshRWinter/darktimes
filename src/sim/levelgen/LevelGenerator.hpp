...
private:
    ...
    std::vector<LevelFloorInternal> generate_grid(const std::vector<LevelFloorInternal> &existing_floors,
                                                  const LevelFloorInternal &start_floor,
                                                  LevelSide start_side);
    std::vector<LevelFloorInternal> generate_linear(const std::vector<LevelFloorInternal> &existing_floors,
                                                    const LevelFloorInternal &start_floor,
                                                    LevelSide start_side);
    std::vector<LevelFloorInternal> generate_structure(const std::vector<LevelFloorInternal> &existing_floors,
